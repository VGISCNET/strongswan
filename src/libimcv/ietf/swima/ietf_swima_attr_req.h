...
struct ietf_swima_attr_req_t {
	...
	/**
	 * Add Software Identity target
	 *
	 * @param sw_record		SW ID in a record (not cloned by constructor)
	 */
	void (*add_target)(ietf_swima_attr_req_t *this, swima_record_t *sw_record);
